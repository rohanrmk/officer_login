...
class Taluka extends StatefulWidget {
  const Taluka({Key? key}) : super(key: key);

  @override
  State<Taluka> createState() => _TalukaState();
}

class _TalukaState extends State<Taluka> {
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: DropdownButtonFormField<String>(
                                        ...
                                        items: TalukaList.map(
                                                (TalukaList) =>
                                                DropdownMenuItem<String>(
                                                  value: TalukaList,
                                                  child: Text(TalukaList,
                                                      style: const TextStyle(
                                                          fontSize: 16)),
                                                )).toList(),
                                        onChanged: (TalukaList) =>
                                            setState(() => selectedTaluka =
                                                TalukaList),
                                        menuMaxHeight: 300,
                                      ),
                                    ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: DataTable2(
                                          ...
                                          columns: const [
                                            ...
                                            DataColumn(
                                              label: Center(child: Text('Resolved',style: TextStyle(fontSize: 11))),
                                              numeric: true,
                                            ),
                                          ],
                                          rows: List<DataRow>.generate(
                                              11,
                                                ...
                                                const DataCell(Center(child: Text('Tuljapur',style: TextStyle(fontSize: 11),))),
                                                const DataCell(Center(child: Text('60',style: TextStyle(fontSize: 11),))),
                                                const DataCell(Center(child: Text('50',style: TextStyle(fontSize: 11),))),
                                                const DataCell(Center(child: Text('10',style: TextStyle(fontSize: 11),)))
                                              ]))),
                                    ),
                                  ),
                                ],
