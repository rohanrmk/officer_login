...
import 'Grievance PartialResolved.dart';

class Grievance_Recieved_Resolved extends StatefulWidget {
  const Grievance_Recieved_Resolved({Key? key}) : super(key: key);

  @override
  State<Grievance_Recieved_Resolved> createState() => _Grievance_Recieved_ResolvedState();
}

class _Grievance_Recieved_ResolvedState extends State<Grievance_Recieved_Resolved> {

  String resolved = 'Resolved';

  String partialresolved = 'Partial resolved';
  String groupVal = 'Resolved';
    ...
    return SafeArea(
      child: Scaffold(
        body: NotificationListener<OverscrollIndicatorNotification>(
          ...
          child: groupVal == resolved ?ListView(
                                                          ...
                                                          onPressed: () {
                                                            showDialog(
                                                              ...
                                                              builder: (ctx) => AlertDialog(shape: OutlineInputBorder(
                                                                ...
                                                                content: const Text("Grievance has been Resolved."),
                                                                actions: <Widget>[
                                                                  MaterialButton(
                                                                    shape: RoundedRectangleBorder(
                                                                        borderRadius:
          ...
          ): const Grievance_Recieved_PartialResolved(),
        ),
      ),
    );
  }
